...
install_node_addin <- function() {
  ...
  tryCatch(
    ...
    error = function(e) {
      ...
      if (rstudioapi::showQuestion("[flowR] Use Docker mode?", "The local Node.js installation failed. If you have Docker installed on your system, you can enable Docker mode instead. Would you like to do so now?")) {
